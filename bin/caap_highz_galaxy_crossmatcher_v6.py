    ...
    def match_morphology(self, OutputDir='results', OutputName='', Overwrite=False, FoV=15.0):
        if len(self.FitsImageData)>0 and self.Source and self.RefSource:
            ...
            if True:
                ...
                Position_RA, Position_DEC = zoomwcs.wcs_pix2world(PhotAper_Array[temp_index_x1FWHM]['Shape'].center, 1)
                ...
                TextFilePtr.write("Match.Photometry.Position = [%.10f, %.10f]\n"%(self.Match['Photometry']['Position'][0], self.Match['Photometry']['Position'][1]))
                TextFilePtr.write("Match.Photometry.Centroid = [%.10f, %.10f]\n"%(self.Match['Photometry']['Centroid'][0], self.Match['Photometry']['Centroid'][1]))
